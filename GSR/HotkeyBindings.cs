...
internal sealed class HotkeyBindings
{
	...
	public List<InputBinding> FullScreenButtonBindings { get; set; } = [ InputManager.CreateInputBindingForScanCode(ScanCode.SC_F, ScanCode.SC_LSHIFT) ];
	public List<InputBinding> FastForwardButtonBindings { get; set; } = [ InputManager.CreateInputBindingForScanCode(ScanCode.SC_TAB) ];
	public List<InputBinding> SaveStateButtonBindings { get; set; } = [ InputManager.CreateInputBindingForScanCode(ScanCode.SC_LBRACKET) ];
	public List<InputBinding> LoadStateButtonBindings { get; set; } = [ InputManager.CreateInputBindingForScanCode(ScanCode.SC_RBRACKET) ];
	public List<InputBinding> PrevStateSetButtonBindings { get; set; } = [ InputManager.CreateInputBindingForScanCode(ScanCode.SC_MINUS, ScanCode.SC_LSHIFT) ];
	public List<InputBinding> NextStateSetButtonBindings { get; set; } = [ InputManager.CreateInputBindingForScanCode(ScanCode.SC_EQUALS, ScanCode.SC_LSHIFT) ];
	...
	public List<InputBinding> SaveStateSlot1ButtonBindings { get; set; } = [ InputManager.CreateInputBindingForScanCode(ScanCode.SC_F1, ScanCode.SC_LSHIFT) ];
	public List<InputBinding> SaveStateSlot2ButtonBindings { get; set; } = [ InputManager.CreateInputBindingForScanCode(ScanCode.SC_F2, ScanCode.SC_LSHIFT) ];
	public List<InputBinding> SaveStateSlot3ButtonBindings { get; set; } = [ InputManager.CreateInputBindingForScanCode(ScanCode.SC_F3, ScanCode.SC_LSHIFT) ];
	public List<InputBinding> SaveStateSlot4ButtonBindings { get; set; } = [ InputManager.CreateInputBindingForScanCode(ScanCode.SC_F4, ScanCode.SC_LSHIFT) ];
	public List<InputBinding> SaveStateSlot5ButtonBindings { get; set; } = [ InputManager.CreateInputBindingForScanCode(ScanCode.SC_F5, ScanCode.SC_LSHIFT) ];
	public List<InputBinding> SaveStateSlot6ButtonBindings { get; set; } = [ InputManager.CreateInputBindingForScanCode(ScanCode.SC_F6, ScanCode.SC_LSHIFT) ];
	public List<InputBinding> SaveStateSlot7ButtonBindings { get; set; } = [ InputManager.CreateInputBindingForScanCode(ScanCode.SC_F7, ScanCode.SC_LSHIFT) ];
	public List<InputBinding> SaveStateSlot8ButtonBindings { get; set; } = [ InputManager.CreateInputBindingForScanCode(ScanCode.SC_F8, ScanCode.SC_LSHIFT) ];
	public List<InputBinding> SaveStateSlot9ButtonBindings { get; set; } = [ InputManager.CreateInputBindingForScanCode(ScanCode.SC_F9, ScanCode.SC_LSHIFT) ];
	public List<InputBinding> SaveStateSlot10ButtonBindings { get; set; } = [ InputManager.CreateInputBindingForScanCode(ScanCode.SC_F10, ScanCode.SC_LSHIFT) ];

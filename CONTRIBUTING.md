...
- Windows
	- All neccessary build tools can be installed with [VS Community 2026](https://visualstudio.microsoft.com/downloads/) (or any other Visual Studio edition) with the "Desktop development with C++" and ".NET desktop development" workloads.
	- It should be possible to manually install the [Windows SDK](https://developer.microsoft.com/en-us/windows/downloads/windows-sdk/), [clang](https://releases.llvm.org/download.html), [CMake](https://cmake.org/download/), [ninja](https://github.com/ninja-build/ninja/releases), and the [dotnet10 SDK](https://dotnet.microsoft.com/en-us/download/dotnet/10.0) in order to build GSE, but this is not recommended.
- macOS
	...
	- The [dotnet8 SDK](https://dotnet.microsoft.com/en-us/download/dotnet/8.0) (not dotnet10!) should be installed.
- Linux
	...
	- The [dotnet10 SDK](https://dotnet.microsoft.com/en-us/download/dotnet/10.0) is typically provided in package managers, and could be manually installed.
...
Note that Windows typically will need to use the "x64 Native Tools Command Prompt for VS 2026" in order to build the C/C++ libraries (or the ARM64 variant, if your host PC is an ARM64 PC).

Once all C/C++ libraries are compiled, you can fire up your favorite IDE and start doing C# development.
- Windows
	- [VS Community 2026](https://visualstudio.microsoft.com/downloads/) can be used as a C# IDE (you likely already installed this anyways).
- All platforms

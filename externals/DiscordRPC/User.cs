...
public class User
{
	...
	[JsonPropertyName("discriminator"), JsonInclude, JsonNumberHandling(JsonNumberHandling.AllowReadingFromString), Obsolete("Discord no longer uses discriminators.")]
	...
	[JsonPropertyName("global_name"), JsonInclude]
	...
	/// </summary>
	[JsonPropertyName("flags"), JsonInclude]
	...
	/// </summary>
	[JsonPropertyName("premium_type"), JsonInclude]
	public PremiumType Premium { get; internal set; }
...
#pragma warning restore CS0618
	...
	public static string GetAvatarExtension(AvatarFormat format)
	{
